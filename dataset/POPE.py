...
class POPEDataset(BaseDataset):
    def __init__(self, split="val", data_root="/data/coco/", sampling="random", num_samples=500,st_idx=0,ed_idx=3):
        ...
        self.testfiles = [
            ...
            './data/pope/aokvqa/aokvqa_pope_random.json',
            './data/pope/aokvqa/aokvqa_pope_popular.json',
            './data/pope/aokvqa/aokvqa_pope_adversarial.json',
            './data/pope/gqa/gqa_pope_random.json',
            './data/pope/gqa/gqa_pope_popular.json',
            './data/pope/gqa/gqa_pope_adversarial.json'
            # './data/pope/coco_pope_random.json',
            # './data/pope/coco_pope_popular.json',
            # './data/pope/coco_pope_adversarial.json'
        ]
        self.testfiles = self.testfiles[st_idx:ed_idx]
        print(f"Loaded testfiles: {self.testfiles}")
